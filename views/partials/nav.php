        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <?php if ($_SESSION['user'] ?? false) : ?>
            ...
            <div class="relative ml-3">
              ...
              <?php else : ?>
                <a href="/register" class="<?= urlIs('/register') ?  'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5">Register</a>
                <a href="/login" class="<?= urlIs('/login') ?  'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5">Login</a>
