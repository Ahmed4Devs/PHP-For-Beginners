      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" aria-current="page" class="text-gray-300 hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Home</a>
            <a href="/about.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <el-dropdown class="relative ml-3">
            ...
            <el-menu anchor="bottom end" popover class="w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline-1 outline-black/5 transition transition-discrete [--anchor-gap:--spacing(2)] data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in">
              <a href="/" class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">Home</a>
              <a href="/about.php" class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">About</a>
              <a href="/contact.php" class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">Contact</a>
            </el-menu>
          </el-dropdown>
        </div>
      </div>
